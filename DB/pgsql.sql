...
-- Records of banner
-- ----------------------------
INSERT INTO "public"."banner" VALUES (1, '随时随地浏览精彩', 'public/uploads/7e9242cd0c70f96299ca70a5e93d24331634374112409.jpg', 'Opera 的移动浏览器和应用程序速度快、功能丰富，能为 Android 和 iOS 同时提供最佳的网络体验。', 1, '2021-10-16 16:48:36', '2021-10-16 16:53:12', '');
INSERT INTO "public"."banner" VALUES (2, '内置广告拦截功能，助您加快浏览速度', 'public/uploads/e9242cd0c70f96299ca70a5e93d2433c1634374414715.jpg', '内置广告拦截功能让您摆脱无休止的在线广告的干扰。它还能屏蔽挖矿等恶意软件，并帮助加快页面加载，就像一个浏览器“忍者”。', 1, '2021-10-16 16:53:42', '2021-10-16 16:53:42', '');
...
-- Records of home
-- ----------------------------
INSERT INTO "public"."home" VALUES ('暗色和亮色模式让您彰显自我风格', 'public/uploads/42cd0c70f96299ca70a5e93d2433c9471634375060431.jpg', '可通过设置暗色和亮色主题、键盘快捷键、墙纸、扩展程序、收藏夹书签和许多其他选项，对 Opera 进行自定义设定。', 1, '2021-10-16 17:04:27', '2021-10-16 17:32:19', 1);
INSERT INTO "public"."home" VALUES ('内置广告拦截功能，助您加快浏览速度', 'public/uploads/242cd0c70f96299ca70a5e93d2433c941634375041337.jpg', '内置广告拦截功能让您摆脱无休止的在线广告的干扰。它还能屏蔽挖矿等恶意软件，并帮助加快页面加载，就像一个浏览器“忍者”。', 1, '2021-10-16 17:04:07', '2021-10-16 17:31:59', 2);
INSERT INTO "public"."home" VALUES ('内置 Messenger 有助于随时联络', 'public/uploads/9242cd0c70f96299ca70a5e93d2433c91634374944719.jpg', '使用浏览器侧边栏中的内置 Messenger，聊天、浏览一举兼得，无需一直在标签页和应用程序之间切换。', 1, '2021-10-16 17:02:27', '2021-10-16 17:32:31', 3);

-- ----------------------------
-- Table structure for product-categories
-- ----------------------------
DROP TABLE IF EXISTS "public"."product-categories";
...
-- ----------------------------
INSERT INTO "public"."product-categories" VALUES ('男装', 1, '2021-10-16 14:18:46', '2021-10-16 14:18:46', '', '', 1);
INSERT INTO "public"."product-categories" VALUES ('母婴', 1, '2021-10-16 14:18:22', '2021-10-16 14:18:22', '', '', 2);
INSERT INTO "public"."product-categories" VALUES ('玩具', 1, '2021-10-16 14:18:32', '2021-10-16 14:18:32', '', '', 3);
INSERT INTO "public"."product-categories" VALUES ('家居', 1, '2021-10-16 14:17:49', '2021-10-16 14:17:49', '', '', 4);
INSERT INTO "public"."product-categories" VALUES ('女鞋', 1, '2021-10-16 14:17:58', '2021-10-16 14:17:58', '', '', 5);
INSERT INTO "public"."product-categories" VALUES ('箱包', 1, '2021-10-16 14:18:11', '2021-10-16 14:18:11', '', '', 6);
INSERT INTO "public"."product-categories" VALUES ('运动户外', 1, '2021-10-16 14:18:52', '2021-10-16 15:57:04', 'huwai', '运动户外大全列表', 7);
INSERT INTO "public"."product-categories" VALUES ('男鞋', 1, '2021-10-16 14:18:05', '2021-10-16 14:18:05', '', '', 8);
INSERT INTO "public"."product-categories" VALUES ('童装', 1, '2021-10-16 14:18:26', '2021-10-16 14:18:26', '', '', 9);
INSERT INTO "public"."product-categories" VALUES ('女装', 1, '2021-10-16 14:16:35', '2021-10-16 14:17:33', '', '', 10);
INSERT INTO "public"."product-categories" VALUES ('内衣', 1, '2021-10-16 14:17:42', '2021-10-16 14:17:42', '', '', 11);
...
-- Records of user
-- ----------------------------
INSERT INTO "public"."user" VALUES (1, 'string', '9fdcc68e701706d3c631b4efbd4b3c1ba2a04fc6', 'string', 'string', 'string', 1, '2021-10-14 15:59:51', '2021-10-14 15:59:53');
INSERT INTO "public"."user" VALUES (2, 'admin999', 'cc7a44b5c8e0acf84b181059e1e3cec069cb7cdd', 'string', 'string', 'string', 1, '2021-10-15 16:19:34', '2021-10-15 16:19:39');

-- ----------------------------
-- Primary Key structure for table about
-- ----------------------------
ALTER TABLE "public"."about" ADD CONSTRAINT "about_pkey" PRIMARY KEY ("id");
...
-- ----------------------------
ALTER TABLE "public"."home" ADD CONSTRAINT "home_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Primary Key structure for table product-categories
-- ----------------------------
ALTER TABLE "public"."product-categories" ADD CONSTRAINT "product-categories_pkey" PRIMARY KEY ("id");
